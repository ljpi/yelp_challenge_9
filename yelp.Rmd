---
title: "Modeling Restaurant-Goer's Behavior in The Great Recession: An Econometric Case Study"
author: "Lester Pi"
date: "3/18/2017"
output:
...
4. Level sets vs. growth rates. Growth rates allow our data to be transformed into stationary (or nearly stationary) data. However, they do not always make intuitive sense for this case study. Therefore, I used the levels for creating linear models, but used growth rates for determining Granger causality.
...
<!-- descriptive_stats(lm_d1_adj_rev_adj_star) -->
<!-- descriptive_stats(lm_d2_adj_rev_adj_star) -->
<!-- descriptive_stats(lm_d3_adj_rev_adj_star) -->
<!-- descriptive_stats(lm_d4_adj_rev_adj_star) -->
...
The results of the VAR models are not very assuring. They don't point to any real causal inferences. More research and work needs to be done to create a truley causal inference model.
...
It was determined that the causality model was not valid and needs more research and work..

#Future Work

1. If possible, examine all of Yelp's data, not just the Dataset Challenge.
2. In the event of a future recession, add the data in to create a more comprehensive model.
3. Do a stronger NLP analysis such as bigrams or creating a timeseries of words related to prices.
4. Improve the VAR models.
