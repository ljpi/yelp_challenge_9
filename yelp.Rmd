...
vm_gdp_exp=VAR(gdp_exp_combined,p=4)
plot(vm_gdp_exp$y)
summary(vm_gdp_exp)

grangertest(rest_real_exp_diff_log~gdp_growth_subset[1:length(gdp_growth_subset)])
grangertest(gdp_growth_subset[1:length(gdp_growth_subset)]~rest_real_exp_diff_log)
...
yes gdp granger causes restaurant expenditures + recession dummy :O



#connect reviews with restaurants
cuz #reviews to gdp is a far stretch
...
vm_rev_exp=VAR(rev_exp_combined,p=4)
plot(vm_rev_exp$y)
summary(vm_rev_exp)

grangertest(rest_real_exp_diff_log~log_rev_quarter)
grangertest(log_rev_quarter~rest_real_exp_diff_log)
...
vm_rev_adj_exp=VAR(rev_adj_exp_combined,p=4)
